...
def placeFormPage(aplace, user, formAction='', returnURL='/'):
	...
	ret += '</li>\r'
	ret += '<li>'
	ret += '<label for="address">Address<em></em></label>'
	ret += '<input class=\"editform\" name="address" id="address" placeholder="Street address" value="' + fstr(aplace.address) + '">'
	ret += '</li>\r'
	ret += '<li>'
	ret += '<label for="address2"><em></em></label>'
	ret += '<input class=\"editform\" name="address2" id="address2" placeholder="Additional street address" value="' + fstr(aplace.address2) + '">'
	ret += '</li>\r'
	...
	ret += '<input class=\"editform\" name="email" id="email" type="email" placeholder="Email address for Place" value="' + fstr(aplace.email) + '">'
	ret += '</li>\r'
	ret += '</li>\r'
	ret += '<li>'
	ret += '<label for="url">URL<em></em></label>'
	ret += '<input class=\"editform\" name="url" id="url" type="url" placeholder="URL" value="' + fstr(aplace.URL) + '">'
	ret += '</li>\r'
	ret += '<li>'
	...
	ret += '<input class="editform" name="owner" id="owner" type="email" placeholder="Places Database Owner" value="' + fstr(aplace.owner, user.email()) + '">'
	ret += '</li>\r'
	ret += '<li>'
